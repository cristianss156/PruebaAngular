...
import { Injectable, inject, Injector, runInInjectionContext, Inject, Optional, NgModule } from '@angular/core';
import * as i2 from '@angular/common';
import { XhrFactory } from '@angular/common';
import { HttpHeaders, HttpParams, HttpResponse, HttpXhrBackend, HttpBackend } from '@angular/common/http';
...
class InMemoryBackendConfig {
  ...
  static ɵfac = i0.ɵɵngDeclareFactory({
    ...
    deps: [{
      token: InMemoryBackendConfigArgs
    }],
...
class HttpClientBackendService extends BackendService {
  ...
  static ɵfac = i0.ɵɵngDeclareFactory({
    ...
    version: "0.0.0",
    ngImport: i0,
    type: HttpClientBackendService,
    deps: [{
      token: InMemoryDbService
    }, {
...
//# sourceMappingURL=angular-in-memory-web-api.mjs.map
