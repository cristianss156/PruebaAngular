...
switch ($q) {
  ...
  case 3:
    ...
    $updateIva->execute();
    $auxReturn = ($updateIva->rowCount() !== 0) ? "1" : "0";
  ...
  case 4:
    ...
    $insert->bindValue($_TYPESTR, $_tipo, PDO::PARAM_STR);
    $insert->execute();
